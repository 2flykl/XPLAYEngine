...
export function finishStudioBuild(manifest,assets={}){
  ...
  const dna=generateWorldDNA(manifest.engine,manifest.description||manifest.prompt||'',manifest.feel||'action',{airportTheme:false,palette:manifest.styleDNA?.palette,environment:manifest.visualIntelligence?.environment});
